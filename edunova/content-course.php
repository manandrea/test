<div class="courseContentTitle">
	<?php
		$program_subtitle_meta_value = get_post_meta(get_the_ID(), 'program-subtitle-meta-text', true);
		if(!empty($program_subtitle_meta_value)) {
			echo '<h2>' . $program_subtitle_meta_value . '</h2>';
		}
	?>
</div>
<div class="courseImage" itemprop="image" itemscope itemtype="https://schema.org/ImageObject">
	<?php
