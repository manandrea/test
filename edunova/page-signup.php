<?php /* Template Name: Upiši Se - Formular */ ?>
<?php get_header();?>
<section>
	<!-- Page Title -->
		...
		<div id="pageContentContact">
			...
			<div id="signUpForm" class="container-fluid bcgWhite">
				<div class="container">
					<div class="row">
						<form method="POST" action="<?php echo get_template_directory_uri(); ?>/contact/edusignupcheck.php" accept-charset="utf-8">
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 leftSide">
								...
								<input type="text" name="eduAddress" placeholder="ADRESA" required/>
								<input type="text" name="eduCity" placeholder="MJESTO STANOVANJA" required/>
							...
							<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 rightSide">
								<div class="boot-list">
									<select required class="selectpicker" name="Course" data-size="10" data-dropup-auto=false>
								...
								<textarea name="eduMessage" placeholder="PORUKA" required></textarea>
